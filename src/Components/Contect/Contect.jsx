  ...
  return (
    <div className='contact'>
        <div className="contact-col">
           ...
           <p>Feel free to reach out thorugh contect form or find our contact
            ...
            <ul>
                ...
                <li> <img src={phone_icon} alt="" />+1234-123-4567</li>
                <li> <img src={location_icon} alt="" />Aligrah , India <br />MA 0345, Uttar
                 Pradesh</li>
            </ul>
        </div>
        <div className="contact-col">
